...
const baseWithIcon = {
  ...base,
  iconUrl: CHAIN_CONFIGS.base.iconUrl,
  iconBackground: CHAIN_CONFIGS.base.iconBackground,
};

const soneiumWithIcon = {
  ...soneium,
  name: CHAIN_CONFIGS.soneium.label,
  iconUrl: CHAIN_CONFIGS.soneium.iconUrl,
