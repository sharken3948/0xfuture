...
export function LanguageSelector() {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-1.5 text-[11px] text-[#a78bfa]/70 hover:text-[#a78bfa] transition-colors px-1.5 py-1 rounded-lg hover:bg-[#a78bfa]/10"
      >
        <img src={`https://flagcdn.com/24x18/${current.countryCode}.png`} alt={language} width={16} height={12} className="rounded-sm" />
